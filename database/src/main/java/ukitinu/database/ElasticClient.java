...
import ukitinu.database.search.Query;
import ukitinu.database.search.Search;
...
final class ElasticClient
{
    ...
    Document getSingle(String index, String id) throws DatabaseException
    {
        try {
