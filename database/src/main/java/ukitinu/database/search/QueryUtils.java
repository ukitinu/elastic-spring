package ukitinu.database.search;

import ukitinu.database.DatabaseUtils;
...
public final class QueryUtils
{
    ...
    private static void addGeoBox(FilterElements queryPart, String geoField, Map<String, Object> box)
    {
            ...
            double topRightLat = DatabaseUtils.roundCoordinate(topRight.get(FIELD_LAT));
            double topRightLon = DatabaseUtils.roundCoordinate(topRight.get(FIELD_LON));
            double bottomLeftLat = DatabaseUtils.roundCoordinate(bottomLeft.get(FIELD_LAT));
            double bottomLeftLon = DatabaseUtils.roundCoordinate(bottomLeft.get(FIELD_LON));
